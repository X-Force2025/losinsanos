...
class Interseccion:
    def __init__(self, prob_vehiculo=0.7, duracion_semaforo=30, tiempo_simulacion=300):
...
# Ejecutar la simulación con alta carga vehicular (probabilidad de 0.7)
if __name__ == "__main__":
    interseccion = Interseccion(prob_vehiculo=0.7, duracion_semaforo=30, tiempo_simulacion=300)
